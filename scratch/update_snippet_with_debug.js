    ...
    register_rest_route('custom/v1', '/debug', array(
        ...
        'callback' => function() {
            return array(
                ...
                'url_39' => wp_get_attachment_url(39),
                'url_38' => wp_get_attachment_url(38)
            );
        },
...
async function updateSnippet() {
  ...
  try {
    ...
    console.log('Updating snippet #5 with debug URLs...');
    const snippetData = {
      code: phpCodeWithDebugUpdate
    };
