<?php
/* Template Name: Catalogus Senioren Stoelen */
?>
<!DOCTYPE html>
<html lang="nl">
<head>
  ...
  <title>Senioren Stoelen | Ergonomisch & Comfortabel</title>
  ...
  <header class="navbar">
    <div class="container navbar-container">
      ...
      <div class="navbar-row-2">
          ...
          <a href="<?php echo home_url('/senioren-stoelen/'); ?>" class="active" id="linkSeniorenstoelen">Senioren Stoelen</a>
  ...
  <section class="occasions-header" style="text-align: left;">
    <div class="container banner-flex-container" style="justify-content: flex-start; align-items: flex-start;">
      <div style="text-align: left; max-width: 600px; flex: 1; min-width: 280px;">
        ...
        <h1 style="color: var(--color-light); margin: 4px 0 8px 0; font-size: 2.5rem;">Senioren Stoelen</h1>
        <p style="margin: 0; color: rgba(255, 255, 255, 0.85); font-size: 1.1rem;">Comfortabel en ergonomisch zitten op maat. Ontdek onze collectie senioren stoelen van topkwaliteit.</p>
      </div>
    </div>
  </section>
